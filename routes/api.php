...
Route::delete('/mountains/{id}', [MountainController::class, 'destroy'])->middleware(['auth:sanctum', 'ability:admin']);
...
Route::get('/climbing_registrations', [ClimbingRegistrationController::class, 'index'])->middleware(['auth:sanctum', 'ability:admin']);
Route::get('/climbing_registrations/users/{id}', [ClimbingRegistrationController::class, 'showByUserId'])->middleware(['auth:sanctum', 'ability:user']);
